...
mod tests {
    use crate::gateway::claude::{
        ...
        normalize_model_id, parse_metadata_user_id, sort_headers_by_wire_order,
        ClaudeCodeValidator, ClaudeHeaders, TLSFingerprint, DEFAULT_CIPHER_SUITES, DEFAULT_CURVES,
    };
