...
impl ClaudeHeaders {
    ...
    pub fn build(&self, auth_token: &str, beta: &str) -> HeaderMap {
        ...
        headers.insert("X-Stainless-Package-Version", self.stainless_package_version.parse().unwrap());
        ...
        headers.insert("X-Stainless-Runtime", self.stainless_runtime.parse().unwrap());
        
        // 9. X-Stainless-Runtime-Version
        headers.insert("X-Stainless-Runtime-Version", self.stainless_runtime_version.parse().unwrap());
        ...
        headers.insert(
            "anthropic-version",
            self.anthropic_version.parse().unwrap()
        );
    ...
    pub fn build_ordered(&self, auth_token: &str, beta: &str) -> Vec<(&'static str, String)> {
        vec![
            ...
            ("X-Stainless-Package-Version", self.stainless_package_version.clone()),
            ...
            ("X-Stainless-Runtime-Version", self.stainless_runtime_version.clone()),
